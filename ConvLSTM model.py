...
'''
def train_model(X_train, y_train, n_steps, n_length, verbose=1, epochs=25, batch_size=100):
...
def plot_predictions(predictions, dataset, input_size, output_size=48):
    ...
    pyplot.title("ConvLSTM forecast")
    pyplot.legend()
    pyplot.show()

if __name__ == '__main__':
    dataset, input_size, n_steps, n_length = start_params('30_minute_data.csv')
