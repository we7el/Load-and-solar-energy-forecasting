...
def model_architecture(X_train, y_train):
    ...
    model = Sequential()
    model.add(Conv1D(filters=98, kernel_size=2, activation='relu', input_shape=(time_steps, features)))
...
'''
def train_model(X_train, y_train, verbose=1, epochs=20, batch_size=100):
